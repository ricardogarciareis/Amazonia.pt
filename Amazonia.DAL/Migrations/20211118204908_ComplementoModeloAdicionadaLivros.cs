...
namespace Amazonia.DAL.Migrations
{
    public partial class ComplementoModeloAdicionadaLivros : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(
                name: "LivrosImpressos");

            migrationBuilder.DropPrimaryKey(
                name: "PK_LivrosPeriodicos",
                table: "LivrosPeriodicos");

            migrationBuilder.RenameTable(
                name: "LivrosPeriodicos",
                newName: "Livros");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LivrosDigitais", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LivrosImpressos", x => x.Id);
                });
        }
    }
}
